...
def perguntar_ao_chatbot(pergunta):
    ...
    if vector_store is None:
        raise RuntimeError("O chatbot de compliance não foi inicializado. Chame criar_chatbot_compliance() primeiro.")
    ...
    contexto_relevante = "\n---\n".join([text_chunks[i].page_content for i in indices[0]])
